...
public class ddMenuListarProdutosEmOrdemCrescenteDeValidade extends MenuAbstrato implements Menu{
    public ddMenuListarProdutosEmOrdemCrescenteDeValidade(Estoque MBA, Scanner sc) {
        super(MBA, sc);
    }
    ...
    public boolean exibirMenu() throws EstoqueExceptions {
        String menu = "";
        menu += "====================================================================" + LS;
        menu += "|======== Listar Produtos Em Ordem Crescente de Validade ==========|" + LS;
        menu += "====================================================================" + LS;
        ...
        if (produtos.isEmpty()) {
            ...
            produtosOrdenados.sort(new ComparadorValidade());
